...
class TwitterClient {
  constructor(bearerToken, aiConfig = {}) {
    ...
    this.cerebrasKey = aiConfig.cerebrasApiKey || process.env.CEREBRAS_API_KEY || process.env.CEREBRAS_API_KEY;
    this.groqKey = aiConfig.groqApiKey || process.env.GROQ_API_KEY || process.env.GROQ_API_KEY;
